...
const buttonClass = ({ size, className, color }: ChacaButtonProps) => {
  return clsx(
    "font-fontBold text-white rounded-md flex items-center fill-white transition-all duration-300 hover:opacity-70",
    className,
    {
      "py-1 px-5 text-base": size === "small",
      "py-1 px-5 text-lg": size === "medium",
      "py-2 px-7 text-xl": size === "large",
    },
    {
