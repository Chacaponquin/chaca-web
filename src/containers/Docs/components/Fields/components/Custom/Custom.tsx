  ...
  return (
    <>
      ...
      <P>
        ...
        los <Link to={ADDRESS.redirect}>modules</Link> que brinda Chaca. Por ejemplo al definir un{" "}
        <Link to={SCHEMA.redirect}>schema</Link> <MiniCode>Movie</MiniCode> que contenga información
        básica acerca de una película se puede hacer utilizando estos{" "}
        <Link to={ADDRESS.redirect}>modules</Link>.
      </P>

      <MovieSchemaDefinition />

      <P>
        Con este ejemplo solo se utilizan datos de los <Link to={ADDRESS.redirect}>modules</Link>{" "}
