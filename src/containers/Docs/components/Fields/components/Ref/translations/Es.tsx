    ...
    <>
      ...
      <Warning title="Referencias nulas">
        <P>
          ...
          secuencial. Por lo cuando se crea el primer documento, al buscar una referencia en el
          propio <Link to={SCHEMA.redirect}>schema</Link> no existirán documentos para referenciar.
          Por esta razón, es que el primer documento generado siempre tendrá valor{" "}
