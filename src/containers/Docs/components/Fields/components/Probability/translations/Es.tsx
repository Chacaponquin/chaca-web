...
export default function Es() {
  return (
    <>
      <P>
        Al utilizar un <Link to={ENUM.redirect}>campo enum</Link> o un{" "}
        <Link to={PICK.redirect}>campo pick</Link> todos los valores definidos como posibles tienen
        la misma posibilidad de ser escogidos. Para los casos en los cuales se quiera priorizar uno
        o varios valores sobre el resto el método <MiniCode>probability</MiniCode> resulta una
        opción ideal.
      </P>
