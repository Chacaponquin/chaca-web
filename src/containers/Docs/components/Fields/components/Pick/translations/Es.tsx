  ...
  return (
    <>
      ...
      <P>
        ...
        pertenecientes a los definidos como valores posibles, pero en este caso en el arreglo no
      ...
      <P>
        ...
        recibe estos estados y debe devolver un número o los límites del arreglo a generar.
      </P>
