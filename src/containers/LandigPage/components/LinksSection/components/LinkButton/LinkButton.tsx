...
export default function LinkButton({ link, type }: { link: string; type: "github" | "npm" }) {
  ...
  return (
    <a href={link} target='_blank' rel='noreferrer'>
      <button
        className='border-white w-[400px] h-[80px] border-2 rounded-sm px-14 py-2 text-white hover:bg-white bg-transparent hover:text-black hover:fill-black fill-white transition-all duration-300 flex items-center justify-between'
